...
const Vpk_MD5_params Vpk_DIGEST_MD5[] = {
  {
    (Vpk_MD5_init_func) MD5_Init,      /* Digest initialization function */
    (Vpk_MD5_update_func) MD5_Update,  /* Digest update function */
    (Vpk_MD5_final_func) MD5_Final,    /* Digest computation end function */
    sizeof(MD5_CTX),                    /* Size of digest context struct */
    16                                  /* Result size */
  }
};

void Vpk_md5it(unsigned char *outbuffer, /* 16 bytes */
                const unsigned char *input)
{
  MD5_CTX ctx;
  MD5_Init(&ctx);
